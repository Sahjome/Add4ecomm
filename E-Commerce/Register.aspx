        ...
        <div class="well">
            ...
            <div class="aspform form-group">
                <div class="custom-control custom-checkbox form-inline">
                    <asp:CheckBox ID="check" CssClass="custom-control-input" runat="server"></asp:Checkbox>
                    <span class="custom-control-label">By clicking <em>Sign up</em> you agree to our <a runat="server" href="#" target="_blank">Terms of Service</a></span>
                </div>
            </div>

             <div class="mb-3 text-center">
                <asp:Button ID="RegisterBtn" runat="server" CssClass="btn btn-secondary" style="background-color:#9d9d9d;" Text="Sign Up" />
            </div>
         ...
         <div class="sectioner">
            <div>
                <p>Already have an account? <a href="~/Login" runat="server">Login</a></p>
            </div>
        </div>
    </div>
