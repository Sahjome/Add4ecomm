       ...
       <%-- <p class="text-uppercase">Before leaving we implore to give your review on the product after at least a week
        ...
        <div class="well">
            ...
            <div class="aspform form-group">
                ...
                <asp:DropDownList ID="carType" CssClass="form-control" TabIndex="1" runat="server"></asp:DropDownList>
            </div>

            <div class="aspform form-group">
                <label class="control-label">Car Brand: </label>
                <asp:DropDownList ID="carBrand" CssClass="form-control" TabIndex="2" runat="server"></asp:DropDownList>
            </div>
        
            <div class="aspform form-group">
                <label class="control-label">Car Model: </label>
                <asp:DropDownList ID="carModel" CssClass="form-control" TabIndex="3" runat="server"></asp:DropDownList>
            </div>
            ...
            <div class="aspform form-group">
                ...
                <div class="col">
                    <asp:TextBox ID="rating" runat="server" CssClass="custom-range" TabIndex="4" TextMode="Range" min="1" step="0.5" max=10></asp:TextBox>
                </div>
            </div>
            <div class="text-center mb-3">
                <asp:Button ID="SurveyBtn" CssClass="btn btn-secondary" TabIndex="5" style="background-color:#9d9d9d;" runat="server" Text="Submit" />
            </div>
        </div>
    </div>
</asp:Content>